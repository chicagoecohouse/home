...
(function() {
  ...
  Volunateer = (function() {
    ...
    Volunateer.prototype.styledIframe = function() {
      console.log($("iframe").contents().find(".cssForm"));
      return $("iframe").contents().find(".cssForm").css(this.styledForm());
    };

    Volunateer.prototype.styledForm = function() {
      var styles;
      return styles = {
        "font-size": "18px",
        "font-family": "inherit",
  ...
  window.Volunateer = Volunateer;

  (new Volunateer).styledIframe();
